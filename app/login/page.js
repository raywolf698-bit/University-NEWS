      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 1rem', position: 'relative', zIndex: 10 }}>
        <div style={{ width: '100%', maxWidth: 440 }} className="card">
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: 'rgba(244,7,86,0.15)',
                border: '1px solid rgba(244,7,86,0.3)',
                color: '#F40756', fontSize: 10, fontWeight: 800,
                padding: '4px 14px', borderRadius: 20, letterSpacing: 1.5,
                marginBottom: 16
            ...
            <div style={{ padding: '2rem' }}>
              {error && (
                <div style={{
                  ...
                  color: '#ff6b9d', fontSize: 13, marginBottom: '1.5rem',
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '1.75rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                    ...
                    <Link href="/forgot-password" style={{ fontSize: 12, color: '#F40756', fontWeight: 600 }}>
                      Forgot password?
                    </Link>
                  </div>
                  <input
              ...
              <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>
                ...
                <Link href="/register" style={{ color: '#F40756', fontWeight: 700 }}>
                  Register here
                </Link>
              </div>
            </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
            <Link href="/" style={{ color: 'rgba(255,255,255,0.25)', fontSize: 13, transition: 'color 0.2s' }}>
              ← Back to Homepage
            </Link>
          </div>
        </div>
