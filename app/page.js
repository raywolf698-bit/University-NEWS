          ...
          <>
              ...
              {featured && (
                <Link href={`/articles/${featured.slug}`} className="hero-card" style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{ color: '#fff', fontSize: 30, fontWeight: 900, lineHeight: 1.2, marginBottom: 10 }}>
                      {featured.title}
                    </h2>
            ...
            <div style={{
              ...
              <div style={{ flex: '0 0 220px' }}>
                ...
                <h3 style={{ color: '#fff', fontSize: 24, fontWeight: 900, lineHeight: 1.2, marginBottom: 10 }}>
